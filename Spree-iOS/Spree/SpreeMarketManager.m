...
- (instancetype)init {
    self = [super init];
    if (self) {
        self.markets = [[NSArray alloc] initWithObjects:@{@"name":@"Bay Area", @"UUID":@"1", @"read_center_lat": @(37.569267), @"read_center_long": @(-122.177065), @"read_radius":@160934, @"write_center_lat":@(37.349668), @"write_center_long":@(-121.939057), @"write_radius" : @160934}, nil];
    }
    return self;
}
