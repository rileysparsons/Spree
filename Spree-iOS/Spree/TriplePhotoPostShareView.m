...
@implementation TriplePhotoPostShareView
...
-(void)setupImageViewsWithImageArray:(NSArray *)array{
    ...
    self.imageView3.image = [array objectAtIndex:2];
}


-(void)initializationComplete{
    
    if (self.postAuthorLabel.text.length > 1 && self.imageView1.image && self.imageView2.image && self.imageView3.image){
