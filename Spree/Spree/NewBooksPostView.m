...
@implementation NewBooksPostView

-(void)awakeFromNib {
    [[NSBundle mainBundle] loadNibNamed:@"NewBooksPostView" owner:self options:nil];
...
-(void)setupAppearance{
    ...
    UIView *leftViewClass = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 10, _classField.frame.size.height)];
    _classField.leftView = leftViewClass;
    _classField.leftViewMode = UITextFieldViewModeAlways;
    _classField.layer.cornerRadius = _priceField.frame.size.height/2;
    _classField.layer.masksToBounds=YES;
    _classField.layer.borderColor=[[UIColor spreeDarkBlue]CGColor];
    _classField.layer.borderWidth= 1.0f;
    ...
    _classField.layer.cornerRadius = 15.0;
    _classField.layer.masksToBounds=YES;
    _classField.layer.borderColor=[[UIColor spreeDarkBlue]CGColor];
    _classField.layer.borderWidth= 1.0f;
